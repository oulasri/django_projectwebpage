...
},{"./vendor/jdataview":16}],3:[function(_dereq_,module,exports){
var DataFile = _dereq_('./data-file'), Viewer = _dereq_('./viewer'), SegmentCollection = _dereq_('./segment-collection'), Segment = _dereq_('./segment'), Style = _dereq_('./style'), utils = _dereq_('./utils'), Controls = _dereq_('./controls'), TimeSpan = _dereq_('./time-span/time-span'), SparseTimeSpan = _dereq_('./time-span/sparse-time-span'), ContinuousTimeSpan = _dereq_('./time-span/continuous-time-span'), Draggable = _dereq_('./time-span/draggable'), TimeSpanCollection = _dereq_('./time-span/time-span-collection'), SparseTimeSpanCollection = _dereq_('./time-span/sparse-time-span-collection'), ContinuousTimeSpanCollection = _dereq_('./time-span/continuous-time-span-collection');
var api = {
        DataFile: DataFile,
        Viewer: Viewer,
...
var defaultOptions = {
        ...
        autoScrollTarget: 0.2,
        autoScrollThreshold: 0.9,
        autoScrollAnimationDuration: 400,
        autoScrollTimeout: 800,
        autoScrollMouseLock: true,
        zoomChangeFactor: 2,
        cacheOffset: false,
        init: null
    };
...
},{"./controls":1,"./data-file":2,"./segment":5,"./segment-collection":4,"./style":6,"./time-span/continuous-time-span":8,"./time-span/continuous-time-span-collection":7,"./time-span/draggable":9,"./time-span/sparse-time-span":11,"./time-span/sparse-time-span-collection":10,"./time-span/time-span":14,"./time-span/time-span-collection":12,"./utils":15,"./viewer":18}],4:[function(_dereq_,module,exports){
...
},{"./utils":15}],6:[function(_dereq_,module,exports){
var Utils = _dereq_('./utils');
var Style = function () {
...
},{"./utils":15}],7:[function(_dereq_,module,exports){
...
},{"./continuous-time-span":8,"./time-span-collection":12}],8:[function(_dereq_,module,exports){
    ...
    span.getStartLimits = function () {
        ...
        if (this.getPrev()) {
            ...
            if (this.getStart() !== null) {
                limits.s = limits.e = this.getStart();
            }
        }
        return limits;
    };
...
},{"./time-span":14}],9:[function(_dereq_,module,exports){
var Draggable = function (span, viewer, style) {
    ...
    var ext = function () {
        ...
        this.getStartElement().on('mousedown', function (e) {
            dragHandler.call(this, e, true);
        });
        this.getEndElement().on('mousedown', function (e) {
...
},{"./sparse-time-span":11,"./time-span-collection":12}],11:[function(_dereq_,module,exports){
var TimeSpan = _dereq_('./time-span');
...
},{"./time-span":14}],12:[function(_dereq_,module,exports){
...
},{"./continuous-time-span":8,"./draggable":9,"./sparse-time-span":11,"./time-span-error":13}],13:[function(_dereq_,module,exports){
...
},{"../utils":15,"./time-span-error":13}],15:[function(_dereq_,module,exports){
...
},{"buffer":19}],17:[function(_dereq_,module,exports){
...
Viewer.prototype = {
    ...
    autoScroll: function (time) {
        ...
        if (this.options.autoScrollType == 'jumpy' || this.options.autoScrollType == 'jumpy-animated') {
            ...
            if (cursorX >= scrollX && cursorX < scrollX + width && !tooQuick) {
...
},{"base64-js":20,"ieee754":21}],20:[function(_dereq_,module,exports){
